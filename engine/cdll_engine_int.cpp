...
public:
	...
	virtual uint GetProtocolVersion() { return 32; /*DUMMY*/ }
	virtual bool IsWindowedMode() { return false; /*DUMMY*/ }

	// Flash the window (os specific)
	virtual void	FlashWindow() { /*DUMMY*/ };

	// Client version from the steam.inf, this will be compared to the GC version
	virtual int GetClientVersion() const { return 32; /*DUMMY*/ } // engines build

	// Is App Active 
	virtual bool IsActiveApp() { return false; /*DUMMY*/ };

	virtual void DisconnectInternal() { /*DUMMY*/ };

	virtual int GetInstancesRunningCount( ) { return false; /*DUMMY*/ };
	...
	virtual bool CopyLocalFile(const char *source, const char *destination) { return false; /*DUMMY*/ };
	...
	virtual int	GetLevelVersion( void ) { return 32; /*DUMMY*/ };
	virtual bool IsLevelMainMenuBackground( void );
	virtual void GetMainMenuBackgroundName( char *dest, int destlen );

	// Get video modes
	virtual void		GetVideoModes( int &nCount, vmode_s *&pModes ) { /*DUMMY*/ };
	...
	virtual int	GetDemoRecordingTick( void ) { return NULL; /*DUMMY*/ };
	virtual int	GetDemoPlaybackTick( void ) { return NULL; /*DUMMY*/ };
	virtual int	GetDemoPlaybackStartTick( void ) { return NULL; /*DUMMY*/ };
	virtual float GetDemoPlaybackTimeScale( void ) { return NULL; /*DUMMY*/ };
	virtual int	GetDemoPlaybackTotalTicks( void ) { return NULL; /*DUMMY*/ };
	...
	virtual void SetGamestatsData( CGamestatsData *pGamestatsData ) { /*DUMMY*/ };
	virtual CGamestatsData *GetGamestatsData() { return NULL; /*DUMMY*/ };
	...
	virtual void ServerCmdKeyValues( KeyValues *pKeyValues ) { /*DUMMY*/ };

	virtual bool IsSkippingPlayback( void ) { return NULL; /*DUMMY*/ };
	virtual bool IsLoadingDemo( void ) {  return NULL; /*DUMMY*/ };
	...
	virtual bool IsPlayingDemoALocallyRecordedDemo() {  return NULL; /*DUMMY*/ };
