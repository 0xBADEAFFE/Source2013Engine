...
public:
	...
	virtual uint32 GetDebugInfoSize() { return NULL; /*DUMMY*/ }
	virtual void SaveDebugInfo( void *pvDebugInfo ) { /*DUMMY*/ };
	virtual void RestoreDebugInfo( const void *pvDebugInfo ) { /*DUMMY*/ };	
	virtual void InitDebugInfo( void *pvDebugInfo, const char *pchRootFileName, int nLine ) { /*DUMMY*/ };

	// Replacement for ::GlobalMemoryStatus which accounts for unused memory in our system
	virtual void GlobalMemoryStatus( size_t *pUsedMemory, size_t *pFreeMemory ) { /*DUMMY*/ };
