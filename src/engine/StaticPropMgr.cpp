...
public:
	...
	virtual const Vector&	OBBMinsPreScaled() const { return OBBMins(); /*DUMMY*/ };
	virtual const Vector&	OBBMaxsPreScaled() const { return OBBMaxs(); /*DUMMY*/ };
...
public:
	...
	virtual bool	IgnoresZBuffer( void ) const { return false; /*DUMMY*/ }
...
public:
	...
	void AddColorDecalToStaticProp( Vector const& rayStart, Vector const& rayEnd,
		int staticPropIndex, int decalIndex, bool doTrace, trace_t& tr, bool bUseColor, Color cColor ) { /*DUMMY*/ };
