...
public: // IClientMessageHandlers
	...
	PROCESS_CLC_MESSAGE( FileCRCCheck ){ return true; /*DUMMY*/ }
	PROCESS_CLC_MESSAGE( FileMD5Check ) { return true; /*DUMMY*/ }
#if defined( REPLAY_ENABLED )
	PROCESS_CLC_MESSAGE( SaveReplay );
#endif
	PROCESS_CLC_MESSAGE( CmdKeyValues ) { return true; /*DUMMY*/ }
