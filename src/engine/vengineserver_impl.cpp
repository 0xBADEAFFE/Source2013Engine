...
public:
	...
	*/
	...
	virtual void SetDedicatedServerBenchmarkMode( bool bBenchmarkMode ) {/*DUMMY*/};
	...
	virtual const CSteamID	*GetClientSteamID( edict_t *pPlayerEdict ) { return NULL; /*DUMMY*/}

	// Returns the SteamID of the game server
	virtual const CSteamID	*GetGameServerSteamID() { return NULL; /*DUMMY*/};

	// Send a client command keyvalues
	// keyvalues are deleted inside the function
	virtual void ClientCommandKeyValues( edict_t *pEdict, KeyValues *pCommand ) {/*DUMMY*/};

	// Returns the SteamID of the specified player. It'll be NULL if the player hasn't authenticated yet.
	virtual const CSteamID	*GetClientSteamIDByPlayerIndex( int entnum ) { return NULL; /*DUMMY*/}
	// Gets a list of all clusters' bounds.  Returns total number of clusters.
	virtual int GetClusterCount() { return NULL; /*DUMMY*/ }
	virtual int GetAllClusterBounds( bbox_t *pBBoxList, int maxBBox ) { return NULL; /*DUMMY*/}

	// Create a bot with the given name.  Returns NULL if fake client can't be created
	virtual edict_t		*CreateFakeClientEx( const char *netname, bool bReportFakeClient = true ) { return NULL; /*DUMMY*/ }

	// Server version from the steam.inf, this will be compared to the GC version
	virtual int GetServerVersion() const { return 32; /*DUMMY*/ };
...
//-----------------------------------------------------------------------------
static CMemoryPoolMT s_PVSInfoAllocator( 128, 128 * 64, CMemoryPoolMT::GROW_SLOW, "pvsinfopool" );
